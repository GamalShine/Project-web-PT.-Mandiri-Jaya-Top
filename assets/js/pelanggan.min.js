...
let url, pelanggan = $("#pelanggan").DataTable({
    ...
    columns: [
        ...
        { data: "jenis_kelamin" }, // Kolom untuk jenis kelamin
...
function edit(a) {
    $.ajax({
        url: get_pelangganUrl, // URL untuk mendapatkan data pelanggan
        type: "post",
        dataType: "json",
        data: { id: a },
        success: a => {
...
pelanggan.on("order.dt search.dt", () => {
    pelanggan.column(0, { search: "applied", order: "applied" }).nodes().each((a, e) => {
        a.innerHTML = e + 1;
    });
});
